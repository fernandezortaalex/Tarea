...
select nombre as nombre_equipos, ciudad as ciudad_equipos from equipos;
-- 2. Muestra los nombres de los jugadores y puntos por juego, ordenados por puntos por juego de mayor a menor.
